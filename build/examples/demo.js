...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rmc_picker_assets_index_css__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rmc_m_carousel_assets_index_less__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rmc_m_carousel_assets_index_less___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_rmc_m_carousel_assets_index_less__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_index__ = __webpack_require__(10);
...
var Demo = function (_React$Component) {
    ...
    _createClass(Demo, [{
        ...
        value: function render() {
            return __WEBPACK_IMPORTED_MODULE_3_react__["createElement"]("div", { style: { margin: '10px 0' } }, __WEBPACK_IMPORTED_MODULE_3_react__["createElement"]("h2", null, "Carousel"), __WEBPACK_IMPORTED_MODULE_3_react__["createElement"]("div", null, __WEBPACK_IMPORTED_MODULE_3_react__["createElement"](__WEBPACK_IMPORTED_MODULE_2__src_index__["a" /* default */], null, __WEBPACK_IMPORTED_MODULE_3_react__["createElement"]("a", { target: "_blank", rel: "nofollow me noopener noreferrer", href: "https://www.baidu.com" }, __WEBPACK_IMPORTED_MODULE_3_react__["createElement"]("img", { src: "//d3kpm7yklociqe.cloudfront.net/ext/theme/20181207_banner_jpgwinter/banner.jpg", alt: "" })), __WEBPACK_IMPORTED_MODULE_3_react__["createElement"]("a", { target: "_blank", rel: "nofollow me noopener noreferrer", href: "https://www.baidu.com" }, __WEBPACK_IMPORTED_MODULE_3_react__["createElement"]("img", { src: "//d3kpm7yklociqe.cloudfront.net/ext/theme/20181210_banner_coat/banner.jpg", alt: "" })), __WEBPACK_IMPORTED_MODULE_3_react__["createElement"]("a", { target: "_blank", rel: "nofollow me noopener noreferrer", href: "https://www.baidu.com" }, __WEBPACK_IMPORTED_MODULE_3_react__["createElement"]("img", { src: "//d3kpm7yklociqe.cloudfront.net/ext/theme/20181210_banner_sleep/banner.jpg", alt: "" })), __WEBPACK_IMPORTED_MODULE_3_react__["createElement"]("a", { target: "_blank", rel: "nofollow me noopener noreferrer", href: "https://www.baidu.com" }, __WEBPACK_IMPORTED_MODULE_3_react__["createElement"]("img", { src: "//d3kpm7yklociqe.cloudfront.net/ext/theme/20181207_banner_ethnicwear/banner.jpg", alt: "" })))));
        }
    }]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rmc_m_carousel_assets_index_less__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rmc_m_carousel_assets_index_less___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rmc_m_carousel_assets_index_less__);
...
var Carousel = function (_Component) {
    ...
    function Carousel() {
        ...
        _this.initCarousel = function () {
            ...
            var listStyle = _extends({}, _this.state.listStyle, { width: width }, _this.getTransitionStyle(0, x));
            _this.setState({
        ...
        _this.handleSwiping = function (left) {
            ...
            var listStyle = _extends({}, _this.state.listStyle, _this.getTransitionStyle(0, x));
            _this.setState({
                listStyle: listStyle
            });
        };
        ...
        _this.changePositon = function (nexIndex, step) {
            ...
            if (index === 0 && activeIndex === _this.childNum - 1 && step !== 'pre') {
                ...
                var listStyle = _extends({}, _this.state.listStyle, _this.getTransitionStyle(speed, x));
                _this.setState({
                    listStyle: listStyle,
                    activeIndex: index
                }, function () {
                    var listStyle = _extends({}, _this.state.listStyle, _this.getTransitionStyle(0, _this.state.frameWidth));
                    setTimeout(function () {
                        _this.setState({
                            listStyle: listStyle
                        });
                ...
                // 第一项继续向前滑动
                var _listStyle = _extends({}, _this.state.listStyle, _this.getTransitionStyle(speed, 0));
                _this.setState({
                ...
                var _listStyle2 = _extends({}, _this.state.listStyle, _this.getTransitionStyle(speed, _x));
                _this.setState({
        ...
        _this.renderChildren = function () {
            ...
            if (_this.objType(children) === 'Object') {
                return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("ul", { className: 'rmc_carousel_list' }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("li", { className: 'rmc_carousel_item rmc_carousel_single_item' }, children));
            }
            // 多个返回Array
            var len = children.length;
            var copyFist = __WEBPACK_IMPORTED_MODULE_0_react___default.a.cloneElement(children[0]);
            var copyLast = __WEBPACK_IMPORTED_MODULE_0_react___default.a.cloneElement(children[len - 1]);
            var childrenList = [copyLast].concat(children).concat(copyFist);
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("ul", _extends({ ref: _this.$carouselList, style: listStyle }, touchEvents, mouseEvents, { onClickCapture: _this.handleClick, className: 'rmc_carousel_list' }), childrenList.map(function (child, i) {
                return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("li", { style: itemStyles[i], className: 'rmc_carousel_item', key: i + '-carousel' }, child);
            }));
        };
        // 指示器渲染
        _this.rederDot = function () {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { className: 'rmc_carousel_dot' }, children.map(function (page, i) {
                var dotClassName = 'rmc_carousel_dot_point' + ' ' + (i === _this.state.activeIndex ? 'rmc_dot_point_active' : '');
                return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { onClick: function onClick() {
                        return _this.dotClick(i);
                    }, className: dotClassName, key: i }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span", null));
            }));
        };
        _this.touchObject = {};
        ...
        _this.$carouselList = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createRef();
        _this.$carousel = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createRef();
        return _this;
    }
    ...
    _createClass(Carousel, [{
        ...
        value: function render() {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { ref: this.$carousel, className: 'rmc_carousel' }, this.renderChildren(), dots ? this.rederDot() : null);
        }
    }]);
